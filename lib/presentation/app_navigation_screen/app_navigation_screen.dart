                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildScreenTitle(
                          context,
                          screenTitle: "6-Scanner",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.scannerScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "3-register",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.registerScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "4-Home - Tab Container",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.homeTabContainerScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "7-Account - Container",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.accountContainerScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "5-Detail Plant",
                          onTapScreenTitle: () => onTapScreenTitle(
